        ...
        <div className="body-container">
              ...
              <div className="profile-sub-container">
                <div className="profile-name-container">
                  ...
                  <div className="profile-container-heading">
                    <div className="h1">{selectedUser ? selectedUser.username : userData?.username}</div>
                    <div className="h4">{selectedUser ? selectedUser.email : userData?.email}</div>
                  </div>
                </div>
          ...
          <div className="body-container--right">
            <div className="portfolio-heading-container">
              ...
              <div className="line"></div>
              <div className="portfolio-sub-heading">R {accountData ? accountData.balance.toFixed(2) : 'N/A'}</div>
            </div>
            {/* Coin */}
            <div className="portfolio-card-container shine-hover">
              <div className="coin-card dark-bg--gradient">
                ...
                <div className="coin-card--heading"> {accountData?.coinBalance ?? 0} <span className="coin-card--heading--small">STRP</span> </div>
